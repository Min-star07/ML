...
class NoduleAnalysisApp:
    def __init__(self, sys_argv=None):
        ...
        parser.add_argument(
            ...
            nargs="?",
            default="/home/lim/Desktop/other/ML/pytorch_dlwpt-code-master/data/part2/models/seg_2020-01-26_19.45.12_w4d3c1-bal_1_nodupe-label_pos-d1_fn8-adam.best.state",
        )
        ...
        parser.add_argument(
            ...
            nargs="?",
            default="/home/lim/Desktop/other/ML/pytorch_dlwpt-code-master/data/part2/models/cls_2020-02-06_14.16.55_final-nodule-nonnodule.best.state",
        )
    ...
    def initModels(self):
        ...
        model_cls = getattr(model_ch14, self.cli_args.cls_model)
        cls_model = model_cls()
        ...
        if self.cli_args.malignancy_path:
            model_cls = getattr(model_ch14, self.cli_args.malignancy_model)
